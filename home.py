...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"C:\Facial-Recognition-for-Crime-Detection\img\back.png")
...
def register(entries, required, menu_var):
    ...
    if(len(no_face) > 0):
        ...
        if(rowId >= 0):
            ...
            cv2.imwrite("C:/Facial-Recognition-for-Crime-Detection/profile_pics/criminal %d.png"%profile_img_num,img)
...
def showCriminalProfile(name):
    ...
    path =("C:\\Users\\Ravinder\\Desktop\\New folder (6)\\Facial-Recognition-for-Crime-Detection-master\\profile_pics\\criminal %d.png"%id)
...
logo = tk.PhotoImage(file = r"C:\Facial-Recognition-for-Crime-Detection\img\logo2.png")
